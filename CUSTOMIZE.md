...
You can create new information pages by adding new Markdown files in the [\_information](_information/) directory. The easiest way to do this is to copy an existing project and modify it.
...
This Jekyll theme implements `collections` to let you break up your work into categories. The theme comes with two default collections: `news` and `information`. Items from the `news` collection are automatically displayed on the home page. Items from the `information` collection are displayed on a responsive grid on projects page.

You can easily create your own collections, apps, short stories, courses, or whatever your creative work is. To do this, edit the collections in the [\_config.yml](_config.yml) file, create a corresponding folder, and create a landing page for your collection, similar to [\_pages/information.md](_pages/information.md).
